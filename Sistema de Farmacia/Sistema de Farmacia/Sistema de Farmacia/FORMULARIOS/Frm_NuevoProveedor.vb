Public Class Frm_NuevoProveedor
    ...
    Private Sub btn_guardar_Click(sender As System.Object, e As System.EventArgs) Handles btn_guardar.Click
        Try
            Dim buscaprov = (From proveedor In datacontext.Proveedor Select proveedor.nombre_proveedor, proveedor.direccion_proveedor, proveedor.telefono_proveedor, proveedor.id_localidad Where nombre_proveedor = txt_nombre_proveedor.Text.ToUpper).Any
            ...
            usu.id_localidad = txt_id_localidad.Text
    ...
    Private Sub btn_actualizar_Click(sender As System.Object, e As System.EventArgs) Handles btn_actualizar.Click
        ...
        Try
            ...
            ActualizarProveedor.id_localidad = txt_id_localidad.Text
            datacontext.SubmitChanges()
    ...
    Private Sub btn_buscar_localidad_Click(sender As System.Object, e As System.EventArgs) Handles btn_buscar_localidad.Click
        Frm_ListaLocalidades.Text = "Seleccionar Localidad"
        Frm_ListaLocalidades.Show()
    End Sub
End Class